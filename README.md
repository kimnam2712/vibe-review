...
ES 모듈이라 `file://`로 열면 `src/data/checklist.json`을 불러오지 못합니다. 로컬 정적 서버로 엽니다.
...
vibe-review/
  ...
  src/
    main.js
    styles/main.css
    components/          # InputPanel, ResultPanel, AxisList
    data/checklist.json
    lib/                 # evaluate.js, heuristics.js
  tests/
```
...
- 검사 축 4개 × 문항 3개 (`src/data/checklist.json`, 임시 플레이스홀더)
